...
8. When continuity helper flows have already persisted a working set, prefer that persisted set over recomputing a new one unless the helper-backed freshness model or the user asks to override it.
