...
5. **Check workflow contract fidelity**:
   ...
   - If the implementation hit verified failures or explicit corrections, did it capture a durable lesson with `node $HOME/.agents/scripts/lesson-tools.mjs quick-capture --what "..." --why "..." --rule "..."` or explain why no lesson was promoted?
