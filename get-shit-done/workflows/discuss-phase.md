...
```bash
INIT=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js init phase-op "${PHASE}")
```
...
```bash
node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js commit "docs(${padded_phase}): capture phase context" --files "${phase_dir}/${padded_phase}-CONTEXT.md"
```
