...
```bash
INIT=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js init phase-op "${after_phase}")
```
...
```bash
RESULT=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js phase insert "${after_phase}" "${description}")
```
