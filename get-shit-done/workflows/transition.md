...
```bash
TRANSITION=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js progress bar --raw)
```
