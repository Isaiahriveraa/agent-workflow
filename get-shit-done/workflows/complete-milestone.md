...
```bash
ROADMAP=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js roadmap analyze)
```
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js summary-extract "$summary" --fields one_liner | jq -r '.one_liner'
done
```
...
```bash
ARCHIVE=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js milestone complete "v[X.Y]" --name "[Milestone Name]")
```
...
```bash
INIT=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js init execute-phase "1")
```
...
```bash
node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js commit "chore: complete v[X.Y] milestone" --files .planning/milestones/v[X.Y]-ROADMAP.md .planning/milestones/v[X.Y]-REQUIREMENTS.md .planning/milestones/v[X.Y]-MILESTONE-AUDIT.md .planning/MILESTONES.md .planning/PROJECT.md .planning/STATE.md
```
```
