...
```bash
INIT=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js init phase-op "${PHASE_ARG}")
```
...
```bash
node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js roadmap get-phase "${phase_number}"
...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js frontmatter get "$plan" --field must_haves)
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js verify artifacts "$plan")
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js verify key-links "$plan")
