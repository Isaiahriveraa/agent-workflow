...
```bash
INIT=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js init progress --include state,roadmap,project,config)
```
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js progress bar --raw)
```
