...
```bash
INIT=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js init plan-phase "$PHASE" --include state,roadmap,requirements,context,research,verification,uat)
```
...
```bash
PHASE_INFO=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js roadmap get-phase "${PHASE}")
```
...
```bash
PHASE_DESC=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js roadmap get-phase "${PHASE}" | jq -r '.section')
...
STATE_SNAP=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js state-snapshot)
...
```
Task(
  prompt="First, read /Users/isaiahrivera/.claude/agents/gsd-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
```
Task(
  prompt="First, read /Users/isaiahrivera/.claude/agents/gsd-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
