...
```bash
timestamp=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js current-timestamp full --raw)
```
</step>

<step name="commit">
```bash
node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js commit "wip: [phase-name] paused at task [X]/[Y]" --files .planning/phases/*/.continue-here.md
```
</step>
