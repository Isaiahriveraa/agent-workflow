...
```bash
PHASE_INFO=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node /Users/isaiahrivera/.claude/get-shit-done/bin/gsd-tools.js find-phase "${PHASE}" --raw)
```
