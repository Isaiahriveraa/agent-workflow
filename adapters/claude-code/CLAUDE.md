...
- `~/.agents/AGENTS.md` for system behavior, communication defaults, workflow policy, routing, verification, and execution contract
...
1. `~/.agents/AGENTS.md`
2. `./.agents/repo.md` when the current repo provides it
