...
6. **Need a prototype?** → **`/skill:prototype`** — visual browser workspace with an Excalidraw whiteboard and live previews for schema, data-model, design, and logic questions. Route findings to the plan.
