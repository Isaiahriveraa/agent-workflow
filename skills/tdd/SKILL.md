...
When exploring the codebase, read the project's domain docs (`context/`, `CONTEXT.md`, and ADRs if they exist) so test names and interface vocabulary match the project's domain language.
