...
File naming: `context/plans/NNN-short-slug.md`, numbered in recommended execution order.
...
> in `context/plans/README.md` — unless a reviewer dispatched you and told you they
> maintain the index.
>
...
- **Effort**: S | M | L
- **Risk**: LOW | MED | HIGH
- **Depends on**: context/plans/NNN-*.md (or "none")
...
- [ ] `context/plans/README.md` status row updated
...
## Index file: `context/plans/README.md`
